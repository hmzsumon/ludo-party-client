...
const DashboardHeader = () => {
  ...
  return (
    <div className="relative mt-8">
      ...
      {/* ────────── Notification Block ────────── */}
      <div className="absolute right-0 -top-8 flex items-center gap-4">
      ...
      <div className="flex  items-center justify-between">
        ...
        {/* ────────── Wallet Row ────────── */}
        <div className="flex overflow-hidden rounded-full  bg-[rgba(16,25,69,0.95)] shadow-[0_10px_24px_rgba(0,0,0,0.35)] ring-1 ring-white/10">
